# Generated by Django 4.1.7 on 2023-05-06 17:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=400, verbose_name='имя1')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('last_name', models.CharField(blank=True, max_length=400, verbose_name='имя2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('basket', 'Статус корзины'), ('new', 'Новый')], max_length=15, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items', to='backend.productinfo', verbose_name='Информация о продукте')),
